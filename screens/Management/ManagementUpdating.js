...
const ManagementUpdating = (props) => {
    ...
    const [deposit, setDeposit] = useState(`${props.route.params.deposit}`);
    const [month_fee, setMonth_fee] = useState(`${props.route.params.month_fee}`);
    const [management_fee, setManagement_fee] = useState(`${props.route.params.management_fee}`);
    const [parking_fee, setParking_fee] = useState(`${props.route.params.parking_fee}`);
