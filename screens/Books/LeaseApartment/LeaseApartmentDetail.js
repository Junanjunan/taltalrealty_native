...
const LeaseApartmentDetail = ({navigation, route: {params}}) => {
    const deleteBook = (id) => {
    ...
    return (
        ...
        <Container>
            ...
            <DetailTODiv>
                <DetailTO onPress={() => navigation.navigate("LeaseApartmentUpdating", params)}>
...
export default LeaseApartmentDetail;