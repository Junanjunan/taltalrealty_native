...
const LeaseStoreSearchTable = ({ getLeaseStore, navigation, route: {params}, token, userId}) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(LeaseStoreSearchTable);