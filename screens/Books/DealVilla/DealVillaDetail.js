...
const DealVillaDetail = (props) => {
    ...
    return (
        ...
        <Container>
            ...
            <DetailTODiv>
                <DetailTO onPress={() => props.navigation.navigate("DealVillaUpdating", props.route.params)}>
...
export default connect(mapStateToProps)(DealVillaDetail);