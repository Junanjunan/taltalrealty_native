...
const LeaseStoreDetail = ({navigation, route: {params}}) => {
    const deleteBook = (id) => {
        function sendingData(){
            AsyncStorage.getItem("csrftoken").then(value =>{
                return api.storeLeaseDeleting(id, value);
            }).then(data => {
    ...
    return (
        ...
        <Container>
            ...
            <Div>
                <DetailTO onPress={() => navigation.navigate("LeaseStoreUpdating", params)}>
...
export default LeaseStoreDetail;