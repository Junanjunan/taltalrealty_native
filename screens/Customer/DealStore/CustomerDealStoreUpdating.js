...
const CustomerDealStoreUpdating = ({id, navigation, route: {params}}) => {
    ...
    async function sendingData(){
        if(!guest_phone){
            ...
            AsyncStorage.getItem("csrftoken").then(value => {
                return api.customerStoreDealingUpdating(params.roomId, form, value);
            }).then(data => {
...
export default connect(mapStateToProps)(CustomerDealStoreUpdating);
