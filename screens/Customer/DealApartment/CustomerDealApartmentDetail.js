...
const CustomerDealApartmentDetail = ({navigation, route: {params}}) => {
    const deleteBook = (id) => {
        function sendingData(){
            AsyncStorage.getItem("csrftoken").then(value =>{
                return api.customerApartmentDealingDeleting(id, value);
            }).then(data => {
    ...
    return (
        ...
        <Container>
            ...
            <DetailTODiv>
                <DetailTO onPress={() => navigation.navigate("CustomerDealApartmentUpdating", params)}>
...
export default CustomerDealApartmentDetail;