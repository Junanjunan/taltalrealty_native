...
const CustomerLeaseOfficetelSearchTable = ({ getCustomerLeaseOfficetel, navigation, route: {params}, token, userId}) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(CustomerLeaseOfficetelSearchTable);
