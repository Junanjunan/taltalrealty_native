...
const LeaseOfficetelDetail = ({navigation, route: {params}}) => {
    const deleteBook = (id) => {
        function sendingData(){
            AsyncStorage.getItem("csrftoken").then(value =>{
                return api.officetelLeaseDeleting(id, value);
            }).then(data => {
                alert("오피스텔(임대)가 삭제되었습니다.");
    ...
    return (
        ...
        <Container>
            ...
            <Div>
                <DetailTO onPress={() => navigation.navigate("LeaseOfficetelUpdating", params)}>
...
export default LeaseOfficetelDetail;