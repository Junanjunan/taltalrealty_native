...
const CustomerLeaseApartmentUpdating = (props) => {
    ...
    async function sendingData(){
        if(!guest_phone){
            ...
            AsyncStorage.getItem("csrftoken").then(value => {
                return api.customerApartmentLeaseUpdating(props.route.params.roomId, form, value);
            }).then(data => {
                alert("아파트(임대) 손님이 수정되었습니다.");
...
export default connect(mapStateToProps, mapDispatchToProps)(CustomerLeaseApartmentUpdating);
