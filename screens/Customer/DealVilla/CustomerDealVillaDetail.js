...
const CustomerDealVillaDetail = (props) => {
    const deleteBook = (id) => {
        function sendingData(){
            AsyncStorage.getItem("csrftoken").then(value =>{
                return api.customerVillaDealingDeleting(id, value);
            }).then(data => {
    ...
    return (
        ...
        <Container>
            ...
            <DetailTODiv>
                <DetailTO onPress={() => props.navigation.navigate("CustomerDealVillaUpdating", props.route.params)}>
...
export default CustomerDealVillaDetail;