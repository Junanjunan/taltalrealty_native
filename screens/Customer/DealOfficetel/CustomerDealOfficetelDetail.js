...
const CustomerDealOfficetelDetail = (props) => {
    const deleteBook = (id) => {
        function sendingData(){
            AsyncStorage.getItem("csrftoken").then(value =>{
                return api.customerOfficetelDealingDeleting(id, value);
            }).then(data => {
                alert("빌라(매매) 손님이 삭제되었습니다.");
    ...
    return (
        ...
        <Container>
            ...
            <DetailTODiv>
                <DetailTO onPress={() => props.navigation.navigate("CustomerDealOfficetelUpdating", props.route.params)}>
...
export default CustomerDealOfficetelDetail;