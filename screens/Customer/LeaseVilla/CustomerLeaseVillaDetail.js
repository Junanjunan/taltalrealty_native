...
const CustomerLeaseVillaDetail = ({navigation, route: {params}}) => {
    const deleteBook = (id) => {
        function sendingData(){
            AsyncStorage.getItem("csrftoken").then(value =>{
                return api.customerVillaLeaseDeleting(id, value);
            }).then(data => {
                alert("주택(임대) 손님이 삭제되었습니다.");
    ...
    return (
        ...
        <Container>
            ...
            <DetailTODiv>
                <DetailTO onPress={() => navigation.navigate("CustomerLeaseVillaUpdating", params)}>
...
export default CustomerLeaseVillaDetail;