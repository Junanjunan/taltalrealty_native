...
const LeaseVillaDetail = ({navigation, route: {params}}) => {
    const deleteBook = (id) => {
        function sendingData(){
            AsyncStorage.getItem("csrftoken").then(value =>{
                return api.villaLeaseDeleting(id, value);
            }).then(data => {
                alert("주택(임대) 매물이 삭제되었습니다.");
    ...
    return (
        ...
        <Container>
            ...
            <Div>
                <DetailTO onPress={() => navigation.navigate("LeaseVillaUpdating", params)}>
...
export default LeaseVillaDetail;