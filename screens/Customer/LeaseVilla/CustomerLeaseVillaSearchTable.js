...
const CustomerLeaseVillaSearchTable = ({ getCustomerLeaseVilla, navigation, route: {params}, token, userId}) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(CustomerLeaseVillaSearchTable);
