...
${price&&props.route.params.price ? `${props.route.params.price < 10000 ? `매매가: ${props.route.params.price.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}만원,\n` : `매매가: ${Math.floor(props.route.params.price/10000).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}억${props.route.params.price%10000 !=0 ? ` ${(props.route.params.price%10000).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}만원,\n` : "원,\n"}`}` : ""}
${floor_top&&props.route.params.floor_top ? `지상층: ${props.route.params.floor_top ? props.route.params.floor_top : "" },\n` : ""}
${floor_bottom&&props.route.params.floor_bottom ? `지하층: ${props.route.params.floor_bottom ? props.route.params.floor_bottom : "" },\n` : ""}
${deposit&&props.route.params.deposit ? `${props.route.params.deposit < 10000 ? `보증금: ${props.route.params.deposit.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}만원,\n` : `보증금: ${Math.floor(props.route.params.deposit/10000).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}억${props.route.params.deposit%10000 !=0 ? ` ${(props.route.params.deposit%10000).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}만원,\n` : "원,\n"}`}` : ""}
${month_fee&&props.route.params.month_fee ? `${props.route.params.month_fee < 10000 ? `월세: ${props.route.params.month_fee.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}만원,\n` : `월세: ${Math.floor(props.route.params.month_fee/10000).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}억${props.route.params.month_fee%10000 !=0 ? ` ${(props.route.params.month_fee%10000).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}만원,\n` : "원,\n"}`}` : ""}
${management_fee&&props.route.params.management_fee ? `${props.route.params.management_fee < 10000 ? `관리비: ${props.route.params.management_fee.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}만원,\n` : `관리비: ${Math.floor(props.route.params.management_fee/10000).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}억${props.route.params.management_fee%10000 !=0 ? ` ${(props.route.params.management_fee%10000).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}만원,\n` : "원,\n"}`}` : ""}
